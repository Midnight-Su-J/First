 ...
 */
! function(t, e) {
  "object" === typeof exports && "undefined" !== typeof module ? module.exports = e() : "function" == typeof define && define.amd ? (t.Artplayer = e(), define(function() {
    return t.Artplayer
  })) : (t = "undefined" !== typeof globalThis ? globalThis : t || self).Artplayer = e()
}(this, function() {
  "use strict";
  ...
  var a = (e || (e = 1, r.exports = function() {
    function t(e) {
      ...
      return n(t, e, a), i(t, e, a),
        function(t, e, a) {
          var s = r(e),
            l = r(t);
          if ("object" === s) {
            if ("object" !== l) throw new Error("[Type Error]: '".concat(a.join("."), "' require 'object' type, but got '").concat(l, "'"));
          ...
          if ("array" === s) {
            if ("array" !== l) throw new Error("[Type Error]: '".concat(a.join("."), "' require 'array' type, but got '").concat(l, "'"));
            t.forEach(function(r, s) {
              var l = t[s],
                c = e[s] || e[0],
                d = a.slice();
              d.push(s), n(l, c, d), i(l, c, d), o(l, c, d)
            })
          }
        }(t, e, a), t
    }
    ...
    function n(t, e, a) {
      if ("string" === r(e)) {
        ...
        if ("?" === e[0] && (e = e.slice(1) + "|undefined"), !(-1 < e.indexOf("|") ? e.split("|").map(function(t) {
            ...
            return o === t
          }) : e.toLowerCase().trim() === o)) throw new Error("[Type Error]: '".concat(a.join("."), "' require '").concat(e, "' type, but got '").concat(o, "'"))
      }
    }
  ...
  const o = t(a),
    n = "5.4.0",
    i = {
      properties: ["audioTracks", "autoplay", "buffered", "controller", "controls", "crossOrigin", "currentSrc", "currentTime", "defaultMuted", "defaultPlaybackRate", "duration", "ended", "error", "loop", "mediaGroup", "muted", "networkState", "paused", "playbackRate", "played", "preload", "readyState", "seekable", "seeking", "src", "startDate", "textTracks", "videoTracks", "volume"],
    ...
    s = globalThis?.CUSTOM_USER_AGENT ?? ("undefined" !== typeof navigator ? navigator.userAgent : ""),
    l = /^(?:(?!chrome|android).)*safari/i.test(s),
    c = /iPad|iPhone|iPod/i.test(s) && !window.MSStream,
    d = c || s.includes("Macintosh") && navigator.maxTouchPoints >= 1,
    p = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(s) || d,
  ...
  function $(t, e) {
    k(t).forEach(t => g(t, e)), f(t, e)
  }

  function T(t, e, r = "top") {
    p || (t.setAttribute("aria-label", e), f(t, "hint--rounded"), f(t, `hint--${r}`))
  }
  ...
  function S(t = "", e = "") {
    const r = L("i");
    return f(r, "art-icon"), f(r, `art-icon-${t}`), y(r, e), r
  }

  function M(t, e) {
    let r = document.getElementById(t);
    r || (r = document.createElement("style"), r.id = t, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", () => {
      document.head.appendChild(r)
    }) : (document.head || document.documentElement).appendChild(r)), r.textContent = e
  }
      ...
      o.onload = function() {
        if (e && 1 !== e) {
          const n = document.createElement("canvas"),
            i = n.getContext("2d");
          n.width = o.width * e, n.height = o.height * e, i.drawImage(o, 0, 0, n.width, n.height), n.toBlob(e => {
            const o = URL.createObjectURL(e),
              n = new Image;
            n.onload = function() {
              r(n)
            }, n.onerror = function() {
              URL.revokeObjectURL(o), a(new Error(`Image load failed: ${t}`))
            }, n.src = o
          })
        } else r(o)
      }, o.onerror = function() {
        a(new Error(`Image load failed: ${t}`))
      }, o.src = t
    })
  }
  ...
  function R(t) {
    ...
    const e = [];
    let r = t.target;
    for (; r;) e.push(r), r = r.parentNode;
    return e.includes(window) || void 0 === window || e.push(window), e
  }
  ...
  function q(...t) {
    ...
    return t.reduce((t, r) => (Object.keys(r).forEach(a => {
      const o = t[a],
        n = r[a];
      Array.isArray(o) && Array.isArray(n) ? t[a] = o.concat(...n) : e(o) && e(n) ? t[a] = q(o, n) : t[a] = n
    }), t), {})
  }
  ...
  function Q(t, e) {
    let r = !1;
    return function(...a) {
      r || (t.apply(this, a), r = !0, setTimeout(() => {
        r = !1
      }, e))
    }
  }
  ...
  function st(t, e, r) {
    return _(e === at || e === ot || t instanceof Element, `${r.join(".")} require '${at}' or 'Element' type`)
  }
  const lt = {
      html: st,
      disable: `?${rt}`,
    ...
    ct = {
      ...
      controls: [{
        ...
        position: (t, e, r) => {
          ...
          return _(a.includes(t), `${r.join(".")} only accept ${a.toString()} as parameters`)
        }
      }],
      quality: [{
        default: `?${rt}`,
  ...
  class dt {
    ...
    set show(t) {
      ...
      t ? f(e, r) : g(e, r), this.art.emit(this.name, t)
    }
    toggle() {
      this.show = !this.show
    }
    add(t) {
      ...
      if (e.html = e.html || "", o(e, lt), !this.$parent || !this.name || e.disable) return;
      const r = e.name || `${this.name}${this.id}`;
      _(!this.cache.has(r), `Can't add an existing [${r}] to the [${this.name}]`), this.id += 1;
      const a = L("div");
      f(a, `art-${this.name}`), f(a, `art-${this.name}-${r}`);
      const n = Array.from(this.$parent.children);
      a.dataset.index = e.index || this.id;
      const i = n.find(t => Number(t.dataset.index) >= Number(a.dataset.index));
      i ? i.insertAdjacentElement("beforebegin", a) : y(this.$parent, a), e.html && y(a, e.html), e.style && x(a, e.style), e.tooltip && T(a, e.tooltip);
      const s = [];
      if (e.click) {
        const t = this.art.events.proxy(a, "click", t => {
          t.preventDefault(), e.click.call(this.art, this, t)
        });
        s.push(t)
      }
      return e.selector && ["left", "right"].includes(e.position) && this.selector(e, a, s), this[r] = a, this.cache.set(r, {
        $ref: a,
        events: s,
        option: e
      }), e.mounted && e.mounted.call(this.art, a), a
    }
    remove(t) {
      _(this.cache.has(t), `Can't find [${t}] from the [${this.name}]`);
      const e = this.cache.get(t);
      e.option.beforeUnmount && e.option.beforeUnmount.call(this.art, e.$ref);
      for (const r of e.events) this.art.events.remove(r);
      this.cache.delete(t), delete this[t], b(e.$ref)
    }
    update(t) {
      if (this.cache.has(t.name)) {
        const e = this.cache.get(t.name);
        t = Object.assign(e.option, t), this.remove(t.name)
      }
      return this.add(t)
    }
  }
  class pt extends dt {
    constructor(t) {
      super(t), this.name = "contextmenu", this.$parent = t.template.$contextmenu, p || this.init()
    }
    init() {
      const {
        option: t,
      ...
      t.playbackRate && this.add(function(t) {
        return e => {
          const {
            i18n: r,
            constructor: {
          ...
          } = e, o = a.map(t => `<span data-value="${t}">${1===t?r.get("Normal"):t.toFixed(1)}</span>`).join("");
          return {
            ...t,
            html: `${r.get("Play Speed")}: ${o}`,
            click: (t, r) => {
              const {
                value: a
              } = r.target.dataset;
            ...
            mounted: t => {
              const r = u('[data-value="1"]', t);
              r && $(r, "art-current"), e.on("video:ratechange", () => {
                const r = m("span", t).find(t => Number(t.dataset.value) === e.playbackRate);
                r && $(r, "art-current")
              })
            }
          }
        ...
        name: "playbackRate",
        index: 10
      })), t.aspectRatio && this.add(function(t) {
        return e => {
          const {
            i18n: r,
            constructor: {
          ...
          } = e, o = a.map(t => `<span data-value="${t}">${"default"===t?r.get("Default"):t}</span>`).join("");
          return {
            ...t,
            html: `${r.get("Aspect Ratio")}: ${o}`,
            click: (t, r) => {
              const {
                value: a
              } = r.target.dataset;
            ...
            mounted: t => {
              const r = u('[data-value="default"]', t);
              r && $(r, "art-current"), e.on("aspectRatio", e => {
                const r = m("span", t).find(t => t.dataset.value === e);
                r && $(r, "art-current")
              })
            }
          }
        ...
        return e => {
          ...
          } = e, o = a.map(t => `<span data-value="${t}">${r.get(N(t))}</span>`).join("");
          return {
            ...t,
            html: `${r.get("Video Flip")}: ${o}`,
            click: (t, r) => {
              const {
                value: a
              } = r.target.dataset;
            ...
            mounted: t => {
              const r = u('[data-value="normal"]', t);
              r && $(r, "art-current"), e.on("flip", e => {
                const r = m("span", t).find(t => t.dataset.value === e);
                r && $(r, "art-current")
              })
            }
        ...
        return {
          ...t,
          html: `<a href="https://artplayer.org?ref=${encodeURIComponent(e)}" target="_blank" style="width:100%;">ArtPlayer ${n}</a>`
        }
      }({
        name: "version",
        index: 50
      ...
      for (let o = 0; o < t.contextmenu.length; o++) this.add(t.contextmenu[o]);
      e(r, "contextmenu", t => {
        if (!this.art.constructor.CONTEXTMENU) return;
        t.preventDefault(), this.show = !0;
        const e = t.clientX,
          o = t.clientY,
          {
            height: n,
        ...
        let p = e - s,
          h = o - l;
        e + d > s + i && (p = i - d), o + c > l + n && (h = n - c), x(a, {
          top: `${h}px`,
          left: `${p}px`
        })
      }), e(r, "click", t => {
  ...
  function ht(t, e) {
    const {
      ...
      left: a
    } = P(r), o = D((p ? e.touches[0].clientX : e.clientX) - a, 0, r.clientWidth), n = o / r.clientWidth * t.duration;
    return {
      second: n,
      time: F(n),
      width: o,
      percentage: D(o / r.clientWidth, 0, 1)
    }
  }
  ...
  function ut(t, e) {
    if (t.isRotate) {
      const r = e.touches[0].clientY / t.height,
        a = r * t.duration;
      t.emit("setBar", "played", r, e), t.seek = a
    } else {
      const {
        second: r,
        percentage: a
    ...
    return e => {
      ...
      return {
        ...
        mounted: t => {
          let s = null,
            l = !1;
          const c = u(".art-progress-hover", t),
            d = u(".art-progress-loaded", t),
            h = u(".art-progress-played", t),
            m = u(".art-progress-highlight", t),
            v = u(".art-progress-indicator", t),
            b = u(".art-progress-tip", t);
          ...
          function x(r, a) {
            ...
            b.textContent = n || "00:00";
            const i = b.clientWidth;
            o <= i / 2 ? w(b, "left", 0) : o > t.clientWidth - i / 2 ? w(b, "left", t.clientWidth - i + "px") : w(b, "left", o - i / 2 + "px")
          }
          r.indicator ? y(v, r.indicator) : w(v, "backgroundColor", "var(--art-theme)"), e.on("setBar", function(r, a, o) {
            const i = "played" === r && o && p;
            if ("loaded" === r && w(d, "width", 100 * a + "%"), "hover" === r && (w(c, "width", 100 * a + "%"), C(o, m) ? function(r) {
                const {
                  width: a
                } = ht(e, r), {
                  text: o
                ...
                b.textContent = o;
                const n = b.clientWidth;
                a <= n / 2 ? w(b, "left", 0) : a > t.clientWidth - n / 2 ? w(b, "left", t.clientWidth - n + "px") : w(b, "left", a - n / 2 + "px")
              }(o) : x(o), 0 === a ? g(n, "art-progress-hover") : f(n, "art-progress-hover")), "played" === r && (w(h, "width", 100 * a + "%"), w(v, "left", 100 * a + "%")), i) {
              f(n, "art-progress-hover");
              x(o, {
                width: t.clientWidth * a,
                time: F(a * e.duration)
              }), clearTimeout(s), s = setTimeout(() => {
                g(n, "art-progress-hover")
              }, 500)
            }
          }), e.on("video:loadedmetadata", function() {
            m.textContent = "";
            for (let t = 0; t < a.highlight.length; t++) {
              const r = a.highlight[t],
                o = D(r.time, 0, e.duration) / e.duration * 100,
                n = `<span data-text="${r.text}" data-time="${r.time}" style="left: ${o}%"></span>`;
              y(m, n)
            }
          }), e.constructor.USE_RAF ? e.on("raf", () => {
            e.emit("setBar", "played", e.played), e.emit("setBar", "loaded", e.loaded)
          }) : (e.on("video:timeupdate", () => {
            e.emit("setBar", "played", e.played)
          }), e.on("video:progress", () => {
            e.emit("setBar", "loaded", e.loaded)
          }), e.on("video:ended", () => {
            e.emit("setBar", "played", 1)
          })), e.emit("setBar", "loaded", e.loaded || 0), p || (o(i, "click", t => {
            t.target !== v && ut(e, t)
          }), o(i, "mousemove", t => {
            const {
              percentage: r
            } = ht(e, t);
            e.emit("setBar", "hover", r, t)
          }), o(i, "mouseleave", t => {
            e.emit("setBar", "hover", 0, t)
          }), o(i, "mousedown", t => {
            l = 0 === t.button
  ...
  class ft extends dt {
    constructor(t) {
      super(t), this.isHover = !1, this.name = "control", this.timer = Date.now();
      const {
        constructor: e
      } = t, {
        $player: r,
      ...
      t.on("mousemove", () => {
        ...
        p ? this.toggle() : this.show = !0
      }), t.on("document:mousemove", t => {
        this.isHover = C(t, a)
      }), t.on("video:timeupdate", () => {
        !t.setting.show && !this.isHover && !t.isInput && t.playing && this.show && Date.now() - this.timer >= e.CONTROL_HIDE_TIME && (this.show = !1)
      }), t.on("control", t => {
        t ? (g(r, "art-hide-cursor"), f(r, "art-hover"), this.timer = Date.now()) : (f(r, "art-hide-cursor"), g(r, "art-hover"))
      }), this.init()
    }
    init() {
      const {
      ...
      t.isLive || this.add(mt({
        ...
        return e => ({
          ...
          mounted: t => {
            const {
              ...
              icons: a,
              i18n: o
            } = e, n = y(t, a.play), i = y(t, a.pause);

            function s() {
              w(n, "display", "flex"), w(i, "display", "none")
            }

            function l() {
              w(n, "display", "none"), w(i, "display", "flex")
            }
            T(n, o.get("Play")), T(i, o.get("Pause")), r(n, "click", () => {
              e.play()
            }), r(i, "click", () => {
              e.pause()
            }), e.playing ? l() : s(), e.on("video:playing", () => {
              l()
            }), e.on("video:pause", () => {
              s()
            })
        ...
        return e => ({
          ...
          mounted: t => {
            const {
              proxy: r,
              icons: a
            } = e, o = y(t, a.volume), n = y(t, a.volumeClose), i = y(t, '<div class="art-volume-panel"></div>'), s = y(i, '<div class="art-volume-inner"></div>'), l = y(s, '<div class="art-volume-val"></div>'), c = y(s, '<div class="art-volume-slider"></div>'), d = y(c, '<div class="art-volume-handle"></div>'), h = y(d, '<div class="art-volume-loaded"></div>'), u = y(c, '<div class="art-volume-indicator"></div>');
            ...
            function f() {
              if (e.muted || 0 === e.volume) w(o, "display", "none"), w(n, "display", "flex"), w(u, "top", "100%"), w(h, "top", "100%"), l.textContent = 0;
              else {
                const t = 100 * e.volume;
                w(o, "display", "flex"), w(n, "display", "none"), w(u, "top", 100 - t + "%"), w(h, "top", 100 - t + "%"), l.textContent = Math.floor(t)
              }
            }
            if (f(), e.on("video:volumechange", f), r(o, "click", () => {
                e.muted = !0
              }), r(n, "click", () => {
                e.muted = !1
              }), p) w(i, "display", "none");
              ...
              let t = !1;
              r(c, "mousedown", r => {
                t = 0 === r.button, e.volume = m(r)
              }), e.on("document:mousemove", r => {
                t && (e.muted = !1, e.volume = m(r))
              }), e.on("document:mouseup", () => {
                t && (t = !1)
              })
            }
        ...
        return e => ({
          ...
          mounted: t => {
            function r() {
              const r = `${F(e.currentTime)} / ${F(e.duration)}`;
              r !== t.textContent && (t.textContent = r)
            }
            r();
            const a = ["video:loadedmetadata", "video:timeupdate", "video:progress"];
            for (let o = 0; o < a.length; o++) e.on(a[o], r)
          }
        })
      }({
        name: "time",
        position: "left",
        index: 30
      })), t.quality.length && Z().then(() => {
        this.art.quality = t.quality
      }), t.screenshot && !p && this.add(function(t) {
        return e => ({
          ...t,
        ...
        return e => ({
          ...
          mounted: t => {
            ...
            y(t, a.setting), r(t, "click", () => {
              e.setting.toggle(), e.setting.resize()
            }), e.on("setting", e => {
              T(t, o.get(e ? "Hide Setting" : "Show Setting"))
            })
          }
        })
      }({
        ...
        return e => ({
          ...
          mounted: t => {
            ...
            y(t, a.pip), r(t, "click", () => {
              ...
              T(t, o.get(e ? "Exit PIP Mode" : "PIP Mode"))
            })
          }
        })
      }({
        ...
        position: "right",
        index: 40
      })), t.airplay && window.WebKitPlaybackTargetAvailabilityEvent && this.add(function(t) {
        return e => ({
          ...t,
          ...
          mounted: t => {
            ...
            y(t, a.airplay), r(t, "click", () => e.airplay())
          }
        })
      }({
        name: "airplay",
        position: "right",
        index: 50
      })), t.fullscreenWeb && this.add(function(t) {
        return e => ({
          ...t,
          ...
          mounted: t => {
            const {
              ...
              icons: a,
              i18n: o
            } = e, n = y(t, a.fullscreenWebOn), i = y(t, a.fullscreenWebOff);
            w(i, "display", "none"), r(t, "click", () => {
              e.fullscreenWeb = !e.fullscreenWeb
            }), e.on("fullscreenWeb", e => {
              e ? (T(t, o.get("Exit Web Fullscreen")), w(n, "display", "none"), w(i, "display", "inline-flex")) : (T(t, o.get("Web Fullscreen")), w(n, "display", "inline-flex"), w(i, "display", "none"))
            })
          }
        })
      }({
        ...
        position: "right",
        index: 60
      })), t.fullscreen && this.add(function(t) {
        return e => ({
          ...t,
          ...
          mounted: t => {
            const {
              ...
              icons: a,
              i18n: o
            } = e, n = y(t, a.fullscreenOn), i = y(t, a.fullscreenOff);
            w(i, "display", "none"), r(t, "click", () => {
              e.fullscreen = !e.fullscreen
            }), e.on("fullscreen", e => {
              e ? (T(t, o.get("Exit Fullscreen")), w(n, "display", "none"), w(i, "display", "inline-flex")) : (T(t, o.get("Fullscreen")), w(n, "display", "inline-flex"), w(i, "display", "none"))
            })
          }
        })
      }({
    ...
    add(t) {
      ...
      switch (e.position) {
        ...
        case "right":
          ...
          break;
        default:
          _(!1, "Control option.position must one of 'top', 'left', 'right'")
      }
      super.add(e)
    }
    check(t) {
      if (t) {
        t.$control_value.innerHTML = t.html;
        for (let e = 0; e < t.$control_option.length; e++) {
          const r = t.$control_option[e];
          r.default = r === t, r.default && $(r.$control_item, "art-current")
        }
      }
    }
    selector(t, e, r) {
      ...
      f(e, "art-control-selector");
      const o = L("div");
      f(o, "art-selector-value"), y(o, t.html), e.textContent = "", y(e, o);
      const n = L("div");
      f(n, "art-selector-list"), y(e, n);
      for (let s = 0; s < t.selector.length; s++) {
        const e = t.selector[s],
          r = L("div");
        f(r, "art-selector-item"), e.default && f(r, "art-current"), r.dataset.index = s, r.dataset.value = e.value, r.innerHTML = e.html, y(n, r), H(e, "$control_option", {
          get: () => t.selector
        }), H(e, "$control_item", {
          get: () => r
        }), H(e, "$control_value", {
      ...
      const i = a(n, "click", async e => {
        const r = R(e),
          a = t.selector.find(t => t.$control_item === r.find(e => t.$control_item === e));
        this.check(a), t.onSelect && (o.innerHTML = await t.onSelect.call(this.art, a, a.$control_item, e))
      });
      r.push(i)
    }
  }
  ...
  class vt {
    constructor(t) {
      this.destroyEvents = new Set, this.proxy = this.proxy.bind(this), this.hover = this.hover.bind(this),
        function(t, e) {
          const {
            constructor: r,
            template: {
          ...
          function n(e) {
            C(e, a) ? (t.isInput = "INPUT" === e.target.tagName, t.isFocus = !0, t.emit("focus", e)) : (t.isInput = !1, t.isFocus = !1, t.emit("blur", e))
          }
          t.on("document:click", n), t.on("document:contextmenu", n);
          let i = [];
          e.proxy(o, "click", e => {
            const a = Date.now();
            i.push(a);
            const {
              MOBILE_CLICK_PLAY: o,
              DBCLICK_TIME: n,
              MOBILE_DBCLICK_PLAY: s,
              DBCLICK_FULLSCREEN: l
            } = r, c = i.filter(t => a - t <= n);
            switch (c.length) {
              case 1:
                t.emit("click", e), p ? !t.isLock && o && t.toggle() : t.toggle(), i = c;
                break;
              case 2:
                t.emit("dblclick", e), p ? !t.isLock && s && t.toggle() : l && (t.fullscreen = !t.fullscreen), i = [];
                break;
              default:
                i = []
            }
        ...
        function(t, e) {
          ...
          e.hover(r, e => {
            f(r, "art-hover"), t.emit("hover", !0, e)
          }, e => {
            g(r, "art-hover"), t.emit("hover", !1, e)
          })
        }(t, this),
        function(t, e) {
          const {
        ...
        function(t, e) {
          ...
          const o = J(() => t.emit("resize"), a.RESIZE_TIME);
          t.on("window:orientationchange", () => o()), t.on("window:resize", () => o()), screen && screen.orientation && screen.orientation.onchange && e.proxy(screen.orientation, "change", () => o())
        }(t, this),
        function(t, e) {
          if (p && !t.option.isLive) {
            const {
              $video: r,
              $progress: a
            } = t.template;
            ...
            const c = e => {
                if (1 === e.touches.length && !t.isLock) {
                  ...
                  i = r, s = c, l = t.currentTime
                }
              },
              d = e => {
                if (1 === e.touches.length && n && t.duration) {
                  const {
                    pageX: a,
                    pageY: n
                  } = e.touches[0], c = gt(i, s, a, n), d = [3, 4].includes(c), p = [1, 2].includes(c);
                  if (d && !t.isRotate || p && t.isRotate) {
                    const c = D((a - i) / t.width, -1, 1),
                      d = D((n - s) / t.height, -1, 1),
                      p = t.isRotate ? d : c,
                      h = o === r ? t.constructor.TOUCH_MOVE_RATIO : 1,
                      u = D(l + t.duration * p * h, 0, t.duration);
                    t.seek = u, t.emit("setBar", "played", D(u / t.duration, 0, 1), e), t.notice.show = `${F(u)} / ${F(t.duration)}`
                  }
                }
              },
              p = () => {
                n && (i = 0, s = 0, l = 0, n = !1, o = null)
              };
            t.option.gesture && (e.proxy(r, "touchstart", t => {
              o = r, c(t)
            }), e.proxy(r, "touchmove", d)), e.proxy(a, "touchstart", t => {
              o = a, c(t)
            }), e.proxy(a, "touchmove", d), t.on("document:touchend", p)
          }
        }(t, this),
        function(t) {
          const {
            ...
            t.emit("view", E(a, r.SCROLL_GAP))
          }, r.SCROLL_TIME);
          t.on("window:scroll", () => o()), t.on("view", r => {
            e.autoMini && (t.mini = !r)
          })
        }(t),
        function(t, e) {
          const r = ["click", "mouseup", "keydown", "touchend", "touchmove", "mousemove", "pointerup", "contextmenu", "pointermove", "visibilitychange", "webkitfullscreenchange"],
            a = ["resize", "scroll", "orientationchange"],
            o = [];

          function n(n = {}) {
            for (let t = 0; t < o.length; t++) e.remove(o[t]);
            o.length = 0;
            const {
              $player: i
            } = t.template;
            r.forEach(r => {
              const a = n.document || i.ownerDocument || document,
                s = e.proxy(a, r, e => {
                  t.emit(`document:${r}`, e)
                });
              o.push(s)
            }), a.forEach(r => {
              const a = n.window || i.ownerDocument?.defaultView || window,
                s = e.proxy(a, r, e => {
                  t.emit(`window:${r}`, e)
                });
              o.push(s)
    ...
    proxy(t, e, r, a = {}) {
      ...
      return this.destroyEvents.add(o), o
    }
    hover(t, e, r) {
      e && this.proxy(t, "mouseenter", e), r && this.proxy(t, "mouseleave", r)
    }
    remove(t) {
      if (this.destroyEvents.has(t)) try {
        t()
      } catch (e) {
        console.warn("Failed to remove event listener:", e)
      } finally {
        this.destroyEvents.delete(t)
      }
    }
    destroy() {
      for (const e of this.destroyEvents) try {
        e()
      } catch (t) {
        console.warn("Failed to destroy event listener:", t)
      }
  ...
  class yt {
    constructor(t) {
      this.art = t, this.keys = {}, p || this.init()
    }
    init() {
      const {
        constructor: t
      } = this.art;
      this.art.option.hotkey && (this.add("Escape", () => {
        ...
        this.art.volume -= t.VOLUME_STEP
      })), this.art.on("document:keydown", t => {
        if (this.art.isFocus) {
        ...
        this.art.emit("keydown", t)
      })
    }
    add(t, e) {
      return this.keys[t] ? this.keys[t].includes(e) || this.keys[t].push(e) : this.keys[t] = [e], this
    }
    remove(t, e) {
      if (this.keys[t]) {
        const r = this.keys[t].indexOf(e); - 1 !== r && this.keys[t].splice(r, 1), 0 === this.keys[t].length && delete this.keys[t]
      }
      return this
    }
  }
  ...
  "undefined" !== typeof window && (window["artplayer-i18n-zh-cn"] = bt);
  class wt {
    constructor(t) {
  ...
  class kt extends dt {
    constructor(t) {
      super(t), this.name = "info", p || this.init()
    }
    init() {
      const {
        proxy: t,
      ...
      this.art.on("destroy", () => clearTimeout(n)),
        function t() {
          ...
          n = setTimeout(t, e.INFO_LOOP_TIME)
        }()
    }
  }
  class $t extends dt {
    constructor(t) {
      ...
      for (let a = 0; a < e.layers.length; a++) this.add(e.layers[a])
    }
  }
  class Tt extends dt {
    constructor(t) {
      super(t), this.name = "loading", y(t.template.$loading, t.icons.loading)
    }
  }
  class Et extends dt {
    constructor(t) {
      ...
      const {
        ...
        icons: r,
        events: a
      } = t, o = y(e.$state, r.state), n = y(e.$state, r.error);
      w(n, "display", "none"), t.on("destroy", () => {
        w(o, "display", "none"), w(n, "display", null)
      }), a.proxy(e.$state, "click", () => t.play())
    }
  }
  class Ct {
    constructor(t) {
      this.art = t, this.timer = null, t.on("destroy", () => this.destroy())
    }
    destroy() {
    ...
    set show(t) {
      ...
      t ? (a.textContent = t instanceof Error ? t.message.trim() : t, f(r, "art-notice-show"), clearTimeout(this.timer), this.timer = setTimeout(() => {
        a.textContent = "", g(r, "art-notice-show")
      }, e.NOTICE_TIME)) : g(r, "art-notice-show")
    }
    get show() {
      const {
        template: {
      ...
      return t.classList.contains("art-notice-show")
    }
  }
  const zt = [
    ...
    St = {
      change: Lt.fullscreenchange,
      error: Lt.fullscreenerror
    },
    Mt = {
      request: (t = document.documentElement, e) => new Promise((r, a) => {
        ...
        Mt.on("change", o);
        const n = t[Lt.requestFullscreen](e);
        n instanceof Promise && n.then(o).catch(a)
      }),
      exit: () => new Promise((t, e) => {
        if (!Mt.isFullscreen) return void t();
        const r = () => {
          Mt.off("change", r), t()
        };
        Mt.on("change", r);
        const a = document[Lt.exitFullscreen]();
        a instanceof Promise && a.then(r).catch(e)
      }),
      toggle: (t, e) => Mt.isFullscreen ? Mt.exit() : Mt.request(t, e),
      onchange(t) {
        Mt.on("change", t)
      },
      onerror(t) {
  ...
  function It(t) {
    ...
    t.once("video:loadedmetadata", () => {
      var n;
      Mt.isEnabled ? (n = t, Mt.on("change", () => {
        n.emit("fullscreen", Mt.isFullscreen), Mt.isFullscreen ? (n.state = "fullscreen", f(o, "art-fullscreen")) : g(o, "art-fullscreen"), n.emit("resize")
      }), Mt.on("error", t => {
        n.emit("fullscreenError", t)
      }), H(n, "fullscreen", {
        get: () => Mt.isFullscreen,
        async set(t) {
          t ? await Mt.request(o) : await Mt.exit()
        }
      })) : a.webkitSupportsFullscreen ? (t => {
        t.on("document:webkitfullscreenchange", () => {
          t.emit("fullscreen", t.fullscreen), t.emit("resize")
        }), H(t, "fullscreen", {
          get: () => document.fullscreenElement === a,
          set(e) {
            e ? (t.state = "fullscreen", a.webkitEnterFullscreen()) : a.webkitExitFullscreen()
          }
        })
      })(t) : H(t, "fullscreen", {
        get: () => !1,
  ...
  function Pt(t) {
    ...
    function c() {
      ...
      e && (g(o, "art-mini"), w(e, "display", "none"), o.prepend(n), t.emit("mini", !1))
    }

    function d(e, r) {
      t.playing ? (w(e, "display", "none"), w(r, "display", "flex")) : (w(e, "display", "flex"), w(r, "display", "none"))
    }

    function p() {
      const {
        $mini: e
      } = t.template, r = P(e), o = window.innerHeight - r.height - 50, n = window.innerWidth - r.width - 50;
      a.set("top", o), a.set("left", n), w(e, "top", `${o}px`), w(e, "left", `${n}px`)
    }
    H(t, "mini", {
      get: () => v(o, "art-mini"),
      set(h) {
        if (h) {
          t.state = "mini", f(o, "art-mini");
          const h = function() {
              const {
                $mini: o
              } = t.template;
              if (o) return y(o, n), w(o, "display", "flex");
              {
                const o = L("div");
                f(o, "art-mini-popup"), y(document.body, o), t.template.$mini = o, y(o, n);
                const p = y(o, '<div class="art-mini-close"></div>');
                y(p, e.close), r(p, "click", c);
                const h = y(o, '<div class="art-mini-state"></div>'),
                  u = y(h, e.play),
                  m = y(h, e.pause);
                return r(u, "click", () => t.play()), r(m, "click", () => t.pause()), d(u, m), t.on("video:playing", () => d(u, m)), t.on("video:pause", () => d(u, m)), t.on("video:timeupdate", () => d(u, m)), r(o, "mousedown", t => {
                  i = 0 === t.button, s = t.pageX, l = t.pageY
                }), t.on("document:mousemove", t => {
                  if (i) {
                    f(o, "art-mini-dragging");
                    const e = t.pageX - s,
                      r = t.pageY - l;
                    w(o, "transform", `translate(${e}px, ${r}px)`)
                  }
                }), t.on("document:mouseup", () => {
                  if (i) {
                    i = !1, g(o, "art-mini-dragging");
                    const t = P(o);
                    a.set("left", t.left), a.set("top", t.top), w(o, "left", `${t.left}px`), w(o, "top", `${t.top}px`), w(o, "transform", null)
                  }
                }), o
              }
            }(),
            u = a.get("top"),
            m = a.get("left");
          "number" === typeof u && "number" === typeof m ? (w(h, "top", `${u}px`), w(h, "left", `${m}px`), E(h) || p()) : p(), t.emit("mini", !0)
        } else c()
      }
    })
  }
  ...
  function At(t) {
    ...
    document.pictureInPictureEnabled ? function(t) {
      ...
      e.disablePictureInPicture = !1, H(t, "pip", {
        get: () => document.pictureInPictureElement,
        set(r) {
          r ? (t.state = "pip", e.requestPictureInPicture().catch(t => {
            throw a.show = t, t
    ...
    }(t) : a.webkitSupportsPresentationMode ? function(t) {
      const {
        $video: e
      } = t.template;
      e.webkitSetPresentationMode("inline"), H(t, "pip", {
  ...
  function Rt(t) {
    ...
    let o = null,
      n = !1,
      i = null;
    t.on("setBar", async (o, s, l) => {
      const c = t.controls?.thumbnails,
        {
          url: d,
          scale: h
        } = e.thumbnails;
      if (!c || !d) return;
      if ("hover" === o || "played" === o && l && p) {
        if (i || n || (n = !0, i = await A(d, h), n = !1), !i) return;
        const o = r.clientWidth * s;
        o > 0 && o < r.clientWidth && function(o) {
          const n = t.controls?.thumbnails;
          if (!n) return;
          const {
            number: s,
            column: l,
            ...
            height: d,
            scale: p
          } = e.thumbnails, h = c * p || i.naturalWidth / l, u = d * p || h / (a.videoWidth / a.videoHeight), m = r.clientWidth / s, f = Math.floor(o / m), g = Math.ceil(f / l) - 1, v = f % l || l - 1;
          w(n, "backgroundImage", `url(${i.src})`), w(n, "height", `${u}px`), w(n, "width", `${h}px`), w(n, "backgroundPosition", `-${v*h}px -${g*u}px`), o <= h / 2 ? w(n, "left", 0) : o > r.clientWidth - h / 2 ? w(n, "left", r.clientWidth - h + "px") : w(n, "left", o - h / 2 + "px")
        }(o)
      }
    }), H(t, "thumbnails", {
      get: () => t.option.thumbnails,
      set(e) {
        e.url && !t.option.isLive && (t.option.thumbnails = e, clearTimeout(o), o = null, n = !1, i = null)
      }
    })
  }
  Object.defineProperties(Mt, {
    isFullscreen: {
      get: () => Boolean(document[Lt.fullscreenElement])
    },
    element: {
      enumerable: !0,
      get: () => document[Lt.fullscreenElement]
    },
    isEnabled: {
      enumerable: !0,
      get: () => Boolean(document[Lt.fullscreenEnabled])
    }
  });
  class Ot {
    constructor(t) {
          ...
          async set(a) {
            if (a) {
              const o = t.url,
                n = e.type || V(a),
                i = e.customType[n];
              n && i ? (await Z(), t.loading.show = !0, i.call(t, r, a, t)) : (URL.revokeObjectURL(o), r.src = a), o !== t.url && (t.option.url = a, t.isReady && o && t.once("video:canplay", () => {
                t.emit("restart", a)
              }))
            } else await Z(), t.loading.show = !0
          }
        })
      }(t),
      function(t) {
      ...
      function(t) {
        ...
        H(t, "play", {
          async value() {
            const i = await n.play();
            if (r.show = e.get("Play"), t.emit("play"), a.mutex)
      ...
      function(t) {
        ...
        H(t, "pause", {
          value() {
            const o = e.pause();
            return a.show = r.get("Pause"), t.emit("pause"), o
          }
        })
      }(t),
      function(t) {
      ...
      function(t) {
        ...
        H(t, "seek", {
          set(r) {
            t.currentTime = r, t.duration && (e.show = `${F(t.currentTime)} / ${F(t.duration)}`), t.emit("seek", t.currentTime, r)
          }
        }), H(t, "forward", {
          set(e) {
      ...
      function(t) {
        ...
        H(t, "volume", {
          get: () => e.volume || 0,
          set: t => {
            e.volume = D(t, 0, 1), a.show = `${r.get("Volume")}: ${Number.parseInt(100*e.volume,10)}`, 0 !== e.volume && o.set("volume", e.volume)
          }
        }), H(t, "muted", {
          get: () => e.muted,
          set: r => {
      ...
      function(t) {
        ...
        H(t, "currentTime", {
          get: () => e.currentTime || 0,
          set: r => {
            r = Number.parseFloat(r), Number.isNaN(r) || (e.currentTime = D(r, 0, t.duration))
          }
        })
      }(t),
      function(t) {
      ...
      function(t) {
        function e(e, r) {
          return new Promise((a, o) => {
            if (e === t.url) return void a();
            const {
              playing: n,
              aspectRatio: i,
              playbackRate: s
            } = t;
            t.pause(), t.url = e, t.notice.show = "";
            const l = {
              error: e => {
                t.off("video:canplay", l.canplay), t.off("video:loadedmetadata", l.metadata), o(e)
              },
              metadata: () => {
                t.currentTime = r
              },
              canplay: async () => {
                t.off("video:error", l.error), t.playbackRate = s, t.aspectRatio = i, n && await t.play(), t.notice.show = "", a()
              }
            };
            t.once("video:error", l.error), t.once("video:loadedmetadata", l.metadata), t.once("video:canplay", l.canplay)
          })
        }
        H(t, "switchQuality", {
      ...
      function(t) {
        ...
        H(t, "playbackRate", {
          ...
          set(o) {
            if (o) {
              if (o === e.playbackRate) return;
              e.playbackRate = o, a.show = `${r.get("Rate")}: ${1===o?r.get("Normal"):`${o}x`}`
      ...
      function(t) {
        ...
        H(t, "aspectRatio", {
          get: () => o.dataset.aspectRatio || "default",
          set(n) {
            if (n || (n = "default"), "default" === n) w(a, "width", null), w(a, "height", null), w(a, "margin", null), delete o.dataset.aspectRatio;
            else {
              const t = n.split(":").map(Number),
                ...
                i = e / r,
                s = t[0] / t[1];
              i > s ? (w(a, "width", s * r + "px"), w(a, "height", "100%"), w(a, "margin", "0 auto")) : (w(a, "width", "100%"), w(a, "height", e / s + "px"), w(a, "margin", "auto 0")), o.dataset.aspectRatio = n
            }
            r.show = `${e.get("Aspect Ratio")}: ${"default"===n?e.get("Default"):n}`, t.emit("aspectRatio", n)
          }
        })
      }(t),
      function(t) {
        ...
        H(t, "getDataURL", {
          value: () => new Promise((t, o) => {
            try {
              a.width = r.videoWidth, a.height = r.videoHeight, a.getContext("2d").drawImage(r, 0, 0), t(a.toDataURL("image/png"))
            } catch (n) {
              e.show = n, o(n)
            }
          })
          ...
          value: () => new Promise((t, o) => {
            try {
              a.width = r.videoWidth, a.height = r.videoHeight, a.getContext("2d").drawImage(r, 0, 0), a.toBlob(e => {
          ...
          value: async e => {
            const a = await t.getDataURL();
            return Y(a, `${e||`artplayer_${F(r.currentTime)}`}.png`), t.emit("screenshot", a), a
          }
        })
      }(t), It(t),
        function(t) {
          ...
          let o = "";
          H(t, "fullscreenWeb", {
            get: () => v(a, "art-fullscreen-web"),
            set(n) {
              n ? (o = a.style.cssText, e.FULLSCREEN_WEB_IN_BODY && y(document.body, a), t.state = "fullscreenWeb", w(a, "width", "100%"), w(a, "height", "100%"), f(a, "art-fullscreen-web"), t.emit("fullscreenWeb", !0)) : (e.FULLSCREEN_WEB_IN_BODY && y(r, a), o && (a.style.cssText = o, o = ""), g(a, "art-fullscreen-web"), t.emit("fullscreenWeb", !1)), t.emit("resize")
            }
          })
        }(t), At(t),
        function(t) {
        ...
        function(t) {
          ...
          H(t, "playing", {
            get: () => "boolean" === typeof e.playing ? e.playing : !!(e.currentTime > 0 && !e.paused && !e.ended && e.readyState > 2)
          })
        }(t),
        function(t) {
          const {
          ...
          H(t, "autoSize", {
            value() {
              ...
              if (i / s > l) w(r, "width", s * l / i * 100 + "%"), w(r, "height", "100%");
              else {
                const t = i / l / s * 100;
                w(r, "width", "100%"), w(r, "height", `${t}%`)
              }
              t.emit("autoSize", {
                width: t.width,
                height: t.height
        ...
        function(t) {
          ...
          H(t, "flip", {
            ...
            set(o) {
              o || (o = "normal"), "normal" === o ? delete e.dataset.flip : e.dataset.flip = o, a.show = `${r.get("Video Flip")}: ${r.get(N(o))}`, t.emit("flip", o)
            }
          })
        }(t), Pt(t),
        function(t) {
        ...
        function(t) {
          ...
          H(t, "autoHeight", {
            value() {
              ...
              w(e, "height", `${i}px`), t.emit("autoHeight", i)
            }
          })
        }(t),
        function(t) {
          ...
          H(t, "subtitleOffset", {
            ...
            set(o) {
              ...
              for (let e = 0; e < n.length; e++) {
                const r = n[e];
                r.originalStartTime = r.originalStartTime ?? r.startTime, r.originalEndTime = r.originalEndTime ?? r.endTime, r.startTime = D(r.originalStartTime + i, 0, t.duration), r.endTime = D(r.originalEndTime + i, 0, t.duration)
              }
              t.subtitle.update(), e.show = `${r.get("Subtitle Offset")}: ${o}s`, t.emit("subtitleOffset", o)
            }
          })
        }(t),
        function(t) {
          ...
          let n = !0;
          window.WebKitPlaybackTargetAvailabilityEvent && o.webkitShowPlaybackTargetPicker ? a(o, "webkitplaybacktargetavailabilitychanged", t => {
            ...
            value() {
              n ? (o.webkitShowPlaybackTargetPicker(), t.emit("airplay")) : r.show = e.get("AirPlay Not Available")
            }
          })
        }(t),
        function(t) {
          H(t, "quality", {
            set(e) {
              ...
              r.update({
                ...
                html: n?.html || "",
                selector: e,
                onSelect: async e => (await t.switchQuality(e.url), a.show = `${o.get("Switch Video")}: ${e.html}`, e.html)
              })
            }
          })
        }(t), Rt(t),
        function(t) {
          ...
          let d = 0;
          for (let p = 0; p < i.events.length; p++) n(l, i.events[p], e => {
            t.emit(`video:${e.type}`, e)
          });
          t.on("video:canplay", () => {
            d = 0, t.loading.show = !1
            ...
            d < o.RECONNECT_TIME_MAX ? (await Z(o.RECONNECT_SLEEP_TIME), d += 1, t.url = a.url, r.show = `${e.get("Reconnect")}: ${d}`, t.emit("error", n, d)) : (t.mask.show = !0, t.loading.show = !1, t.controls.show = !0, f(s, "art-error"), await Z(o.RECONNECT_SLEEP_TIME), r.show = e.get("Video Load Failed"))
          }), t.on("video:loadedmetadata", () => {
            t.emit("resize"), p && (t.loading.show = !1, t.controls.show = !0, t.mask.show = !0)
          }), t.on("video:loadstart", () => {
            t.loading.show = !0, t.mask.show = !1, t.controls.show = !0
          }), t.on("video:pause", () => {
            t.controls.show = !0, t.mask.show = !0
          }), t.on("video:play", () => {
            t.mask.show = !1, w(c, "display", "none")
          }), t.on("video:playing", () => {
            t.mask.show = !1
          }), t.on("video:progress", () => {
        ...
        function(t) {
          ...
          for (const i in e.moreVideoAttr) t.attr(i, e.moreVideoAttr[i]);
          e.muted && (t.muted = e.muted), e.volume && (a.volume = D(e.volume, 0, 1));
          const n = r.get("volume");
          "number" === typeof n && (a.volume = D(n, 0, 1)), e.poster && w(o, "backgroundImage", `url(${e.poster})`), e.autoplay && (a.autoplay = e.autoplay), e.playsInline && (a.playsInline = !0, a["webkit-playsinline"] = !0), e.theme && (e.cssVar["--art-theme"] = e.theme);
          for (const i in e.cssVar) t.cssVar(i, e.cssVar[i]);
          t.url = e.url
        }(t)
    }
  }
  ...
  function _t(t) {
    ...
    } = t, n = "art-auto-orientation", i = "art-auto-orientation-fullscreen";
    let s = !1;
    ...
    function l() {
      const {
        videoWidth: t,
        videoHeight: e
      } = o, r = document.documentElement.clientWidth, a = document.documentElement.clientHeight;
      return t > e && r < a || t < e && r > a
    }
    return t.on("fullscreenWeb", e => {
      if (e) {
        if (l()) {
          const e = Number(r.AUTO_ORIENTATION_TIME ?? 0);
          setTimeout(() => {
            t.fullscreenWeb && !v(a, n) && function() {
              const e = document.documentElement.clientWidth,
                r = document.documentElement.clientHeight;
              w(a, "width", `${r}px`), w(a, "height", `${e}px`), w(a, "transform-origin", "0 0"), w(a, "transform", `rotate(90deg) translate(0, -${e}px)`), f(a, n), t.isRotate = !0, t.emit("resize")
            }()
          }, e)
        }
      } else v(a, n) && (w(a, "width", ""), w(a, "height", ""), w(a, "transform-origin", ""), w(a, "transform", ""), g(a, n), t.isRotate = !1, t.emit("resize"))
    }), t.on("fullscreen", async t => {
      const r = !!screen?.orientation?.lock;
      if (t) {
        if (r && l()) try {
          const t = screen.orientation.type.startsWith("portrait") ? "landscape" : "portrait";
          await screen.orientation.lock(t), s = !0, f(a, i)
        } catch (o) {
          s = !1, e.show = o
        }
      } else if (v(a, i) && g(a, i), r && s) {
        try {
  ...
  function Vt(t) {
    ...
    }), l = u(".art-auto-playback-last", s), c = u(".art-auto-playback-jump", s), d = u(".art-auto-playback-close", s);
    y(d, r.close);
    let p = null;

    function h() {
      const r = (a.get("times") || {})[t.option.id || t.option.url];
      clearTimeout(p), w(s, "display", "none"), r && r >= o.AUTO_PLAYBACK_MIN && (w(s, "display", "flex"), l.textContent = `${e.get("Last Seen")} ${F(r)}`, c.textContent = e.get("Jump Play"), n(d, "click", () => {
        w(s, "display", "none")
      }), n(c, "click", () => {
        t.seek = r, t.play(), w(i, "display", "none"), w(s, "display", "none")
    ...
    return t.on("video:timeupdate", () => {
      if (t.playing) {
        const e = a.get("times") || {},
          r = Object.keys(e);
        r.length > o.AUTO_PLAYBACK_MAX && delete e[r[0]], e[t.option.id || t.option.url] = t.currentTime, a.set("times", e)
      }
    }), t.on("ready", h), t.on("restart", h), {
      name: "auto-playback",
      get times() {
        return a.get("times") || {}
      },
      ...
      delete(t) {
        const e = a.get("times") || {};
        return delete e[t], a.set("times", e), e
      }
    }
  }
  ...
  function Yt(t) {
    ...
    let n = null,
      ...
      s = 1;
    const l = () => {
      clearTimeout(n), i && (i = !1, t.playbackRate = s, g(a, "art-fast-forward"))
    };
    return r(o, "touchstart", r => {
      1 === r.touches.length && t.playing && !t.isLock && (n = setTimeout(() => {
        i = !0, s = t.playbackRate, t.playbackRate = e.FAST_FORWARD_VALUE, f(a, "art-fast-forward")
      }, e.FAST_FORWARD_TIME))
    }), t.on("document:touchmove", l), t.on("document:touchend", l), {
      name: "fastForward",
      get state() {
        return v(a, "art-fast-forward")
      }
    }
  }
  ...
  function Dt(t) {
    ...
    function n() {
      f(a, "art-lock"), t.isLock = !0, t.emit("lock", !0)
    }

    function i() {
      g(a, "art-lock"), t.isLock = !1, t.emit("lock", !1)
    }
    return e.add({
      name: "lock",
      mounted(e) {
        const a = y(e, r.lock),
          o = y(e, r.unlock);
        w(a, "display", "none"), t.on("lock", t => {
          t ? (w(a, "display", "inline-flex"), w(o, "display", "none")) : (w(a, "display", "none"), w(o, "display", "inline-flex"))
        })
      },
      click() {
        o() ? i() : n()
  ...
  function Nt(t) {
    return t.on("control", e => {
      e ? g(t.template.$player, "art-mini-progress-bar") : f(t.template.$player, "art-mini-progress-bar")
    }), {
  ...
  class Ft {
    constructor(t) {
      ...
      e.miniProgressBar && !e.isLive && this.add(Nt), e.lock && p && this.add(Dt), e.autoPlayback && !e.isLive && this.add(Vt), e.autoOrientation && p && this.add(_t), e.fastForward && p && !e.isLive && this.add(Yt);
      for (let r = 0; r < e.plugins.length; r++) this.add(e.plugins[r])
    }
    add(t) {
      this.id += 1;
    ...
    next(t, e) {
      ...
      return _(!j(this, r), `Cannot add a plugin that already has the same name: ${r}`), H(this, r, {
        value: e
      }), this
    }
  }
  class Bt extends dt {
    constructor(t) {
      ...
      this.name = "setting", this.$parent = a, this.id = 0, this.active = null, this.cache = new Map, this.option = [...this.builtin, ...e.settings], e.setting && (this.format(), this.render(), t.on("blur", () => {
        this.show && (this.show = !1, this.render())
      }), t.on("focus", t => {
        const e = C(t, r.setting),
          a = C(t, this.$parent);
        !this.show || e || a || (this.show = !1, this.render())
    ...
    get builtin() {
      ...
      return e.playbackRate && t.push(function(t) {
        const {
          i18n: e,
          icons: r,
          constructor: {
        ...
        function i() {
          const e = t.setting.find(`playback-rate-${t.playbackRate}`);
          t.setting.check(e)
        }
        return {
          width: a,
          ...
          tooltip: n(t.playbackRate),
          icon: r.playbackRate,
          selector: o.map(e => ({
            value: e,
            name: `playback-rate-${e}`,
            default: e === t.playbackRate,
            html: n(e)
          })),
          onSelect: e => (t.playbackRate = e.value, e.html),
          mounted: () => {
            i(), t.on("video:ratechange", () => i())
          }
        }
      }(this.art)), e.aspectRatio && t.push(function(t) {
        const {
          i18n: e,
          icons: r,
          constructor: {
        ...
        function i() {
          const e = t.setting.find(`aspect-ratio-${t.aspectRatio}`);
          t.setting.check(e)
        }
        return {
          width: a,
          ...
          mounted: () => {
            i(), t.on("aspectRatio", () => i())
          }
        }
      }(this.art)), e.flip && t.push(function(t) {
        const {
          i18n: e,
          icons: r,
          constructor: {
        ...
        function i() {
          const e = t.setting.find(`flip-${t.flip}`);
          t.setting.check(e)
        }
        return {
          width: a,
      ...
      }(this.art)), e.subtitleOffset && t.push(function(t) {
        const {
          i18n: e,
          icons: r,
          constructor: a
        ...
        return {
          ...
          tooltip: "0s",
          range: [0, -10, 10, .1],
          onChange: e => (t.subtitleOffset = e.range[0], `${e.range[0]}s`),
          mounted: (e, r) => {
            t.on("subtitleOffset", t => {
              r.$range.value = t, r.tooltip = `${t}s`
            })
          }
        }
      }(this.art)), t
    }
    traverse(t, e = this.option) {
      for (let r = 0; r < e.length; r++) {
        const a = e[r];
        t(a), a.selector?.length && this.traverse(t, a.selector)
      }
    }
    check(t) {
      t && (t.$parent.tooltip = t.html, this.traverse(e => {
        e.default = e === t, e.default && e.$item && $(e.$item, "art-current")
      }, t.$option), this.render(t.$parents))
    }
    format(t = this.option, e, r, a = []) {
      for (let o = 0; o < t.length; o++) {
        const n = t[o];
        if (n?.name ? (_(!a.includes(n.name), `The [${n.name}] already exists in [setting]`), a.push(n.name)) : n.name = "setting-" + this.id++, !n.$formatted) {
          H(n, "$parent", {
            get: () => e
          }), H(n, "$parents", {
            get: () => r
    ...
    resize() {
      ...
      if (t.setting && this.show) {
        const n = this.active[0]?.$parent?.width || e,
          {
            left: i,
            width: s
          } = P(t.setting),
          ...
          d = i - l + s / 2 - n / 2;
        if (w(o, "height", `${this.active===this.option?this.active.length*r:(this.active.length+1)*r}px`), w(o, "width", `${n}px`), this.art.isRotate || p) return;
        d + n > c ? (w(o, "left", null), w(o, "right", null)) : (w(o, "left", `${d}px`), w(o, "right", "auto"))
      }
    }
    inactivate(t) {
    ...
    remove(t) {
      const e = this.find(t);
      _(e, `Can't find [${t}] in the [setting]`);
      const r = e.$option.indexOf(e);
      e.$option.splice(r, 1), this.inactivate(e), e.$item && b(e.$item), this.render()
    }
    update(t) {
      const e = this.find(t.name);
      return e ? (this.inactivate(e), Object.assign(e, t), this.format(), this.createItem(e, !0), this.render(), e) : this.add(t)
    }
    add(t, e = this.option) {
      return e.push(t), this.format(), this.createItem(t), this.render(), t
    }
    createHeader(t) {
      if (!this.cache.has(t.$option)) return;
      const e = this.cache.get(t.$option),
        {
          proxy: r,
          icons: {
            arrowLeft: a
        ...
        n = L("div");
      w(n, "height", `${o}px`), f(n, "art-setting-item"), f(n, "art-setting-item-back");
      const i = y(n, '<div class="art-setting-item-left"></div>'),
        s = L("div");
      f(s, "art-setting-item-left-icon"), y(s, a), y(i, s), y(i, t.$parent.html);
      const l = r(n, "click", () => this.render(t.$parents));
      t.$parent.$events.push(l), y(e, n)
    }
    createItem(t, e = !1) {
      if (!this.cache.has(t.$option)) return;
      const r = this.cache.get(t.$option),
        a = t.$item;
      let o = "selector";
      j(t, "switch") && (o = "switch"), j(t, "range") && (o = "range"), j(t, "onClick") && (o = "button");
      const {
        icons: n,
        proxy: i,
        constructor: s
      } = this.art, l = L("div");
      f(l, "art-setting-item"), w(l, "height", `${s.SETTING_ITEM_HEIGHT}px`), l.dataset.name = t.name || "", l.dataset.value = t.value || "";
      const c = y(l, '<div class="art-setting-item-left"></div>'),
        d = y(l, '<div class="art-setting-item-right"></div>'),
        p = L("div");
      switch (f(p, "art-setting-item-left-icon"), o) {
        case "button":
        case "switch":
        case "range":
          y(p, t.icon || n.config);
          break;
        case "selector":
          t.selector?.length ? y(p, t.icon || n.config) : y(p, n.check)
      }
      y(c, p), H(t, "$icon", {
        configurable: !0,
        get: () => p
      ...
      const h = L("div");
      f(h, "art-setting-item-left-text"), y(h, t.html || ""), y(c, h), H(t, "$html", {
        configurable: !0,
        get: () => h
      }), H(t, "html", {
        configurable: !0,
      ...
      const u = L("div");
      switch (f(u, "art-setting-item-right-tooltip"), y(u, t.tooltip || ""), y(d, u), H(t, "$tooltip", {
          configurable: !0,
          get: () => u
        }), H(t, "tooltip", {
          configurable: !0,
        ...
        case "switch": {
          const e = L("div");
          f(e, "art-setting-item-right-icon");
          const r = y(e, n.switchOn),
            a = y(e, n.switchOff);
          w(t.switch ? a : r, "display", "none"), y(d, e), H(t, "$switch", {
            configurable: !0,
            get: () => e
          });
          let o = t.switch;
          H(t, "switch", {
            ...
            get: () => o,
            set(t) {
              o = t, t ? (w(a, "display", "none"), w(r, "display", null)) : (w(a, "display", null), w(r, "display", "none"))
            }
          });
          break
        }
        case "range": {
          const e = L("div");
          f(e, "art-setting-item-right-icon");
          const r = y(e, '<input type="range">');
          r.value = t.range[0], r.min = t.range[1], r.max = t.range[2], r.step = t.range[3], f(r, "art-setting-range"), y(d, e), H(t, "$range", {
            configurable: !0,
            get: () => r
          });
          let a = [...t.range];
          H(t, "range", {
            ...
            get: () => a,
            set(t) {
              a = [...t], r.value = t[0], r.min = t[1], r.max = t[2], r.step = t[3]
            }
          })
        }
        break;
        case "selector":
          if (t.selector?.length) {
            const t = L("div");
            f(t, "art-setting-item-right-icon"), y(t, n.arrowRight), y(d, t)
          }
      }
      switch (o) {
        case "switch":
          if (t.onSwitch) {
            const e = i(l, "click", async e => {
              t.switch = await t.onSwitch.call(this.art, t, l, e)
            });
            t.$events.push(e)
          }
          break;
        case "range":
          if (t.$range) {
            if (t.onRange) {
              const e = i(t.$range, "change", async e => {
                t.range[0] = t.$range.valueAsNumber, t.tooltip = await t.onRange.call(this.art, t, l, e)
              });
              t.$events.push(e)
            }
            if (t.onChange) {
              const e = i(t.$range, "input", async e => {
                t.range[0] = t.$range.valueAsNumber, t.tooltip = await t.onChange.call(this.art, t, l, e)
              });
              t.$events.push(e)
            }
          }
        ...
        case "selector": {
          const e = i(l, "click", async e => {
            t.selector?.length ? this.render(t.selector) : (this.check(t), t.$parent.onSelect && (t.$parent.tooltip = await t.$parent.onSelect.call(this.art, t, l, e)))
          });
          t.$events.push(e), t.default && f(l, "art-current")
        }
        break;
        case "button":
          if (t.onClick) {
            const e = i(l, "click", async e => {
              t.tooltip = await t.onClick.call(this.art, t, l, e)
            });
            t.$events.push(e)
          }
      }
      H(t, "$item", {
        configurable: !0,
        get: () => l
      }), e ? z(l, a) : y(r, l), t.mounted && setTimeout(() => t.mounted.call(this.art, t.$item, t), 0)
    }
    render(t = this.option) {
      if (this.active = t, this.cache.has(t)) {
        $(this.cache.get(t), "art-current")
      } else {
        const e = L("div");
        this.cache.set(t, e), f(e, "art-setting-panel"), y(this.$parent, e), $(e, "art-current"), t[0]?.$parent && this.createHeader(t[0]);
        for (let r = 0; r < t.length; r++) this.createItem(t[r])
      }
      this.resize()
    }
  }
  ...
  class jt extends dt {
    ...
    style(t, e) {
      ...
      return "object" === typeof t ? x(r, t) : w(r, t, e)
    }
    update() {
      const {
        option: {
      ...
      e.innerHTML = "", this.activeCues.length && (this.art.emit("subtitleBeforeUpdate", this.activeCues), e.innerHTML = this.activeCues.map((e, r) => e.text.split(/\r?\n/).filter(t => t.trim()).map(e => `<div class="art-subtitle-line" data-group="${r}">\n                                ${t.escape?B(e):e}\n                            </div>`).join("")).join(""), this.art.emit("subtitleAfterUpdate", this.activeCues))
    }
    async switch (t, e = {}) {
      const {
        i18n: r,
    ...
    createTrack(t, e) {
      ...
      s.default = !0, s.kind = t, s.src = e, s.label = o.subtitle.name || "Artplayer", s.track.mode = "hidden", s.onload = () => {
        this.art.emit("subtitleLoad", this.cues, this.option)
      }, this.art.events.remove(this.destroyEvent), i.onload = null, b(i), y(n, s), r.$track = s, this.destroyEvent = a(this.textTrack, "cuechange", () => this.update())
    }
    async init(t) {
      const {
        notice: e,
      ...
      return this.textTrack ? (o(t, ct.subtitle), t.url ? (this.option = t, this.style(t.style), fetch(t.url).then(t => t.arrayBuffer()).then(e => {
        const r = new TextDecoder(t.encoding).decode(e);
        switch (t.type || V(t.url)) {
          case "srt": {
            const e = X(r);
            return G(t.onVttLoad(e))
          }
          case "ass": {
            const e = K(r);
            return G(t.onVttLoad(e))
          ...
          case "vtt":
            return G(t.onVttLoad(r));
          default:
            return t.url
        }
      }).then(t => (r.innerHTML = "", this.url === t || (URL.revokeObjectURL(this.url), this.createTrack("metadata", t)), t)).catch(t => {
  ...
  class Ut {
    constructor(t) {
      ...
      e.container instanceof Element ? this.$container = e.container : (this.$container = u(e.container), _(this.$container, `No container element found by ${e.container}`)), _(I(), "The current browser does not support flex layout");
      const a = this.$container.tagName.toLowerCase();
      _("div" === a, `Unsupported container element type, only support 'div' but got '${a}'`), _(r.instances.every(t => t.template.$container !== this.$container), "Cannot mount multiple instances on the same dom element"), this.query = this.query.bind(this), this.$container.dataset.artId = t.id, this.init()
    }
    static get html() {
    ...
    query(t) {
      return u(t, this.$container)
    }
    init() {
      const {
        option: t
      } = this.art;
      if (t.useSSR || (this.$container.innerHTML = Ut.html), this.$player = this.query(".art-video-player"), this.$video = this.query(".art-video"), this.$track = this.query("track"), this.$poster = this.query(".art-poster"), this.$subtitle = this.query(".art-subtitle"), this.$danmuku = this.query(".art-danmuku"), this.$bottom = this.query(".art-bottom"), this.$progress = this.query(".art-progress"), this.$controls = this.query(".art-controls"), this.$controlsLeft = this.query(".art-controls-left"), this.$controlsCenter = this.query(".art-controls-center"), this.$controlsRight = this.query(".art-controls-right"), this.$layer = this.query(".art-layers"), this.$loading = this.query(".art-loading"), this.$notice = this.query(".art-notice"), this.$noticeInner = this.query(".art-notice-inner"), this.$mask = this.query(".art-mask"), this.$state = this.query(".art-state"), this.$setting = this.query(".art-settings"), this.$info = this.query(".art-info"), this.$infoPanel = this.query(".art-info-panel"), this.$infoClose = this.query(".art-info-close"), this.$contextmenu = this.query(".art-contextmenus"), t.proxy) {
        const e = t.proxy.call(this.art, this.art);
        _(e instanceof HTMLVideoElement || e instanceof HTMLCanvasElement, "Function 'option.proxy' needs to return 'HTMLVideoElement' or 'HTMLCanvasElement'"), z(e, this.$video), e.className = "art-video", this.$video = e
      }
      t.backdrop && f(this.$player, "art-backdrop"), p && f(this.$player, "art-mobile")
    }
    destroy(t) {
      t ? this.$container.innerHTML = "" : f(this.$player, "art-destroy")
    }
  }
  class qt {
    on(t, e, r) {
    ...
    emit(t, ...e) {
      ...
      for (let a = 0; a < r.length; a += 1) r[a].fn.apply(r[a].ctx, e);
      return this
    }
    off(t, e) {
      const r = this.e || (this.e = {}),
        ...
        o = [];
      if (a && e)
        for (let n = 0, i = a.length; n < i; n += 1) a[n].fn !== e && a[n].fn._ !== e && o.push(a[n]);
  ...
  class Kt extends qt {
    constructor(t, e) {
      if (super(), !h) throw new Error("Artplayer can only be used in the browser environment");
      this.id = ++Xt;
      const r = q(Kt.option, t);
      if (r.container = t.container, this.option = o(r, ct), this.isLock = !1, this.isReady = !1, this.isFocus = !1, this.isInput = !1, this.isRotate = !1, this.isDestroy = !1, this.template = new Ut(this), this.events = new vt(this), this.storage = new Ht(this), this.icons = new xt(this), this.i18n = new wt(this), this.notice = new Ct(this), this.player = new Ot(this), this.layers = new $t(this), this.controls = new ft(this), this.contextmenu = new pt(this), this.subtitle = new jt(this), this.info = new kt(this), this.loading = new Tt(this), this.hotkey = new yt(this), this.mask = new Et(this), this.setting = new Bt(this), this.plugins = new Ft(this), "function" === typeof e && this.on("ready", () => e.call(this, this)), Kt.DEBUG) {
        const t = t => console.log(`[ART.${this.id}] -> ${t}`);
        t(`Version@${Kt.version}`);
        for (let e = 0; e < i.events.length; e++) this.on(`video:${i.events[e]}`, e => t(`Event@${e.type}`))
      }
      Gt.push(this)
    }
